...
namespace MWF.Blog.Host.Configurations.Extensions;

public static class HostExtensions
{
    public static IHost MigrateDatabase<TContext>(this IHost host) where TContext : MWF.BlogDbContext
    {
    ...
    private static void InvokeSeeder<TContext>(TContext context)
        where TContext : MWF.BlogDbContext => context.Database.Migrate();
}